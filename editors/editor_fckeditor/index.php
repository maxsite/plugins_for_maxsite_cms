...
function editor_fckeditor_autoload($args = array())
{
	mso_hook_add( 'editor_custom', 'editor_fckeditor'); # хук на подключение своего редактора
}

function editor_fckeditor($args = array())
{
	
	$editor_config['url'] = getinfo('plugins_url') . 'editor_fckeditor/';
	$editor_config['dir'] = getinfo('plugins_dir') . 'editor_fckeditor/';
