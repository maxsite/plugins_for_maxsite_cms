...
ed.execCommand('mceInsertContent', false, document.getElementById('htmlSourceAdd').value);
tinyMCEPopup.close();
}
...
if (!tinymce.isIE) {
wHeight = self.innerHeight - 88;
wWidth = self.innerWidth - 20;
} else {
wHeight = document.body.clientHeight - 93;
