...
$config = require getinfo('plugins_dir').'editor_tinymce/filemanager/config/config.php';
...
require 'jupload.php';
require getinfo('plugins_dir').'editor_tinymce/filemanager/include/utils.php';
