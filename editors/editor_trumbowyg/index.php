...
function editor_trumbowyg_uninstall($args = array())
{
	mso_delete_option('editor_trumbowyg', 'plugins' ); // удалим созданные опции
	return $args;
}
...
function editor_trumbowyg($args = array())
{
	...
	$options = mso_get_option('editor_trumbowyg', 'plugins', array() ); // получаем опции
