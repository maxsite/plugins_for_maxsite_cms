...
function FCKeditor_autoload( $args = array() )
{
	// хук на подключение своего редактора
	mso_hook_add( 'editor_custom', 'FCKeditor_go' );
}

function FCKeditor_go( $args = array() ) 
{

	$editor_config['url'] = getinfo( 'plugins_url' ) . 'FCKeditor/';
	$editor_config['dir'] = getinfo( 'plugins_dir' ) . 'FCKeditor/';
