...
<div class="comment-form">
	<form action="" method="post">
		<input type="hidden" name="foto_comments_foto_id" value="<?= $foto_id ?>">
		<?= mso_form_session('foto_comments_session') ?>
		...
		<div class="comments-textarea">
			...
			<div><input name="foto_comments_submit" type="submit" value="<?=t('Отправить')?>" class="comments_submit"></div>
