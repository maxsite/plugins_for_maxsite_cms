...
*/
 ...
 /*        
	      ...
	      // иконку-ссылку выведем только если страница смешанная а не конкретного события
	      if ($only_id === false) // если не на странице конкретного события
           ...
           else // или ссылку на автоматически сгенерированную страницу
