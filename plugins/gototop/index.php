...
function gototop_head($args = array())
{
	...
	*/
	...
	<!--[if IE 6]><style type="text/css">#toTop {position: absolute;}</style><![endif]-->
	' . NR;
}
...
{
	echo '<p><a id="toTop" class="png" href="' . getinfo('uri_get') . '#top" title="' . t('Наверх', 'plugins') . '"><span style="display: none;">' . t('&#x21E7; Наверх', 'plugins') . '</span></a></p>';
	return $arg;
}
