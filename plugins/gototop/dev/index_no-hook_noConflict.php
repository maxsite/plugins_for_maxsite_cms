 ...
 * (c) http://max-3000.com/
 *
 * Вариант с добавлением HTML элементов средствами jQuery.
 * При отключении JavaScript кнопка исчезает.
 */
...
//	var button = \'<p><a id="toTop" href="#top" title="' . t('Наверх', 'plugins') . '"><span style="display: none;">&#x21E7; ' . t('Наверх', 'plugins') . '</span></a></p>\';
