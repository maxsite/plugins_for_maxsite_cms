 ...
 * (c) http://max-3000.com/
 */
// в этом файле выводятся сообщения что в массиве $comments (вариант вывода номер 0 - свернутый)


if (!isset($flag_replay)) $flag_replay = false;  // флаг возможности ответа
if (!isset($flag_discussion)) $flag_discussion = false;  // флагчто мы в дискуссии
if (!isset($flag_comuser)) $flag_comuser = true;  // флаг вывода автора
...
foreach ($comments as $key=>$comment)
{
  ...
  // сформируем данные для вывода
    $fn = 'out_comment_do0.php';
     ...
     // выводить ли автора коммента
     if ($flag_comuser)
        $comment_data_out = $profile_link . ' >> ' . $comment_date;
      else $comment_data_out = $comment_date;  
...
<?php
  ...
  // выводим переменные, подготовленные в out_comment_do0.php в сетку
?>
 <tr> 
     ...
     <tr>
      <td>
       <div class="comment_top">
          <span class="comment_date"><?= $comment_data_out ?></span>
