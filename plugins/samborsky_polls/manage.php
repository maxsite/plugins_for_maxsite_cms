...
<div class="polls_addEdit_form">
	<form method="post">
		...
		<div class="polls_manage_ans">
            ...
            <table border="0">
            <caption>Количество проголосовавших не должно быть пустым! Ставьте <b>0</b> или нужное количество.</caption>
			  <tr>
			   <th class="polls_w70">Ответ</th>
			   <th class="polls_w20">Сколько проголосовало</th>
			   <th class="polls_w10">Удалить</th>
			  </tr>
            </table>
			<ul id="sortable_polls">
				...
				<li class="ui-state-default"<?= $st_not_vis ?>>
					<input type="text" name="ans[<?= $nmb ?>][ans]" value="<?= $ans->a_answer ?>" class="polls_w70">
					<input type="text" name="ans[<?= $nmb ?>][votes]" value="<?= $ans->a_votes ?>" class="polls_w20">
					<input type="hidden" name="ans[<?= $nmb ?>][id]" value="<?= $ans->a_id ?>">
					<a href="" class="polls_w10"><img src="<?= $plug_path ?>img/del_ans.png" title="<?= t('удалить ответ')?>"></a>
				</li>
