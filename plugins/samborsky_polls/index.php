...
function samborsky_polls_archive_404($args = array())
{
	...
	if (mso_segment(1) == $archive_url['archive_url'])
	{
	   ...
	   $options = mso_get_option('plugin_samborsky_polls', 'plugins', array());
	   # задаём значения по-умолчанию, если не заданы обязательные
		if( !isset($options['name_header']) ) $options['name_header'] = '';
        ...
        #  meta-данные Для архива голосований
		mso_head_meta('title', $options['head_title']); # meta title страницы
        ...
        #  страница архива голосований
		if ($fn = mso_find_ts_file('main/main-start.php')) require($fn);
        echo '<div class="mso-page-only">';
        echo '<h1>' . $options['name_header'] . '</h1><br>';
